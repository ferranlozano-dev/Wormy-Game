...
public class BonkGame extends Game {
    ...
    BonkGame(GameEngine gameEngine) {
        ...
        bitmapSet.addSprites(R.raw.bm_vida, R.raw.bm_vida_info);
        bitmapSet.addSprites(R.raw.bm_velocidad, R.raw.bm_velocidad_info);
        bitmapSet.addSprites(R.raw.bm_prinprin_enemy, R.raw.bm_prinprin_enemy_info);
    }
